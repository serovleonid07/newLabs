...
def main_menu(db_name: str = "coaching.db"):
    ...
    while True:
        ...
        print("3. Изменить данные Пользователя (User)")
        print("4. Добавить Инвентарь (Inventory)")
        print("5. Изменить данные Инвентаря (Inventory)")
        print("6. Добавить новое Бронирование (Booking)")
        print("7. Изменить существующее Бронирование (Booking)")
        ...
        if choice == '1':
            ...
            modify_inventory_from_console(db_name)
        elif choice == '6':
            ...
            print("Некорректный ввод. Пожалуйста, выберите число от 0 до 7.")
...
if __name__ == '__main__':
    ...
    # Финальная проверка после выхода из меню
    conn = get_connection(DB_NAME)
    print("\n--- Финальный список всех Инвентарей ---")
